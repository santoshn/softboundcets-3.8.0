...
void initializeSoftBoundCETSPass(PassRegistry&);
void initializeFixByValAttributesPass(PassRegistry&);
void initializeInitializeSoftBoundCETSPass(PassRegistry &);
